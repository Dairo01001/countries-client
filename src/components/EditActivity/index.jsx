...
export default function EditActivity ({ activity, setEdit, setActivity }) {
  const [res, setRes] = useState(RESPONSES.DEFAULT)
  const [msg, setMsg] = useState('')

  const { name, difficulty, duration, season, id } = activity
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setMsg('Activity update successfully')
      setTimeout(() => {
...
EditActivity.propTypes = {
  activity: PropTypes.objectOf(PropTypes.shape).isRequired,
